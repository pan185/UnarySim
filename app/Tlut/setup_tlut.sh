#!/bin/bash
# This file should be sourced to set up relavant path for tlut
export TLUT_HOME='/home/zhewen/Repo/UnarySim/app/Tlut'
...
export USYS_OUT_DIR="/home/zhewen/Repo/uSystolic-Sim/outputs"
