...
ufc = TlutLinear(in_feature, out_feature, bias=bias, binary_weight=fc.weight.data, binary_bias=fc.bias, cycle=cycle, bitwidth=bitwidth, rounding=rounding).to(device)
ufc_o = ufc(input)
